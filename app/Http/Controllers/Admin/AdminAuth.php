...
class AdminAuth extends Controller
{
	...
	public function dologin() {
		...
		if (auth()->guard('admin')->attempt(['email' => request('email'), 'password' => request('password')], $rememberme)) {
			...
			session()->flash('error', trans('admin.inccorrect_information_login'));  //  trans ==> resourse/lang/en/ admin.php 
  ...
  // aurl =>  helper function
  //  admin  == auth()->guard('admin');   ==>> helper function
